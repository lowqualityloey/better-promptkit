...
assert_contains "templates/agent-directive-template.md" "Native MCP & Interactive Prompts" "Directive includes native MCP and interactive decision prompts guardrail"
assert_contains "templates/agent-directive-template.md" "Dual-Compatible Action & Next-Step Callouts" "Directive includes dual-compatible action and next-step callout guardrail"
...
assert_contains "templates/agent-directive-template.md" "\[■■■■□□□□□□\]" "Directive specifies block progress bar format"
assert_contains "workflows/commit.md" "### 💡 Next Recommended Step:" "Commit workflow specifies next recommended step callout format"
assert_contains "workflows/commit.md" "\[■■■■□□□□□□\]" "Commit workflow includes block progress bar in callout"
...
assert_contains "workflows/fix.md" "### 💡 Next Recommended Step:" "Fix workflow specifies next recommended step callout format"
