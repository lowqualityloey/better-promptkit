...
echo ""
echo "📌 Scenario J: Standardized Visual Callouts & 3-Column Telemetry Matrix"
...
assert_contains "templates/agent-directive-template.md" "Dual-Compatible 3-Column Telemetry Callouts" "Directive includes dual-compatible 3-column telemetry matrix callout guardrail"
...
assert_contains "templates/agent-directive-template.md" "Milestone Progress | Active Task | System Health" "Directive specifies 3-column telemetry matrix layout"
assert_contains "workflows/commit.md" "Milestone Progress | Active Task | System Health" "Commit workflow includes 3-column telemetry matrix in callout"
assert_contains "workflows/pr.md" "Pull Request & Branch | Milestone & Diff | CI & Quality Gates" "PR workflow includes 3-column telemetry matrix in callout"
assert_contains "workflows/plan.md" "Milestone Progress | Active Task | System Health" "Plan workflow includes 3-column telemetry matrix in callout"
assert_contains "workflows/tasks.md" "Milestone Progress | Active Task | System Health" "Tasks workflow includes 3-column telemetry matrix in callout"
assert_contains "workflows/test.md" "Milestone Progress | Active Task | System Health" "Test workflow includes 3-column telemetry matrix in callout"
assert_contains "workflows/fix.md" "Milestone Progress | Active Task | System Health" "Fix workflow includes 3-column telemetry matrix in callout"
