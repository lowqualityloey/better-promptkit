...
- **Check Identity [Required when evidence is sufficient]**: Local release check 24
- **Failed Job or Command [Required when evidence is sufficient]**: Focused release command 24
- **Failure Output [Required when evidence is sufficient]**: Captured failure output 24.
- **Revision Identifier [Required when evidence is sufficient]**: rev-24
- **Execution Time [Required when evidence is sufficient]**: 2026-09-09T05:24:00Z
- **Configuration Context [Required when evidence is sufficient]**: Local release fixture context 24.
...
- **pk:ship Release Link [Required when state is linked_to_pk_ship]**: `[RELEASE-release-24](../release-24.md#RELEASE-release-24)`
- **Verification Evidence [Required when state is verified or linked_to_pk_ship]**: `Pass - Release verification passed for rev-24.`
