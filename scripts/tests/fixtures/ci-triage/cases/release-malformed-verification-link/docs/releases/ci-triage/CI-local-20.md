...
- **Check Identity [Required when evidence is sufficient]**: Local release check 20
- **Failed Job or Command [Required when evidence is sufficient]**: Focused release command 20
- **Failure Output [Required when evidence is sufficient]**: Captured failure output 20.
- **Revision Identifier [Required when evidence is sufficient]**: rev-20
- **Execution Time [Required when evidence is sufficient]**: 2026-09-09T05:20:00Z
- **Configuration Context [Required when evidence is sufficient]**: Local release fixture context 20.
...
- **pk:ship Release Link [Required when state is linked_to_pk_ship]**: `[RELEASE-release-20](../release-20.md#RELEASE-release-20)`
- **Verification Evidence [Required when state is verified or linked_to_pk_ship]**: `Pass - Release verification passed for rev-20.`
