# Task Record: Valid blocked fixture

- **Record Type**: `Task Record`
- **Task ID**: TASK-2026-09-08-blocked-valid
...
- **Objective**: Preserve a blocked task with a concrete resume condition.
- **In Scope**:
  - `fixture/blocked-valid.md`
- **Explicit Non-Goals**:
  - No remote, release, deployment, or task-record mutation.
- **Dependencies**: External dependency is intentionally unresolved for this stop-state fixture.
...
- **Event-Driven Checkpoints**: Blocker discovery checkpoint
- **Stop Conditions**: Dependency failure
...
- **Next Action**: Resolve the synthetic dependency and revalidate.
...
| ready | blocked | 2026-09-08 14:02 UTC | Fixture validator | Synthetic dependency unavailable | Blocker record |

## 6. Evidence and Completion Gate

- **Changed Files**:
  - `fixture/blocked-valid.md` - Synthetic fixture input.
- **Scope Change Records**: None
- **Checkpoint Records**: None
- **Handoff Records**: None
- **Verification Evidence**: Stop-state fields are concrete.
- **CI Evidence**: Local synthetic case.
- **Review Evidence**: N/A
- **Commit Evidence**: N/A
- **Pull Request Evidence**: N/A
- **Release Evidence**: N/A
- **Blocker and Resume Condition**: Owner: Fixture validator; evidence: dependency unavailable; resume when the synthetic dependency is available.
- **Completion State**: Pending
- **Acceptance Results**: AC-1 Pass - valid blocked state is accepted.
- **Changed-File Summary**: Synthetic blocked task.
