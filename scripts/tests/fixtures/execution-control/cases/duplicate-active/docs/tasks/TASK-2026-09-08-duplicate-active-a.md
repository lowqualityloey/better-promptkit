# Task Record: Duplicate active fixture A

- **Record Type**: `Task Record`
- **Task ID**: TASK-2026-09-08-duplicate-active-a
...
- **Active Task Pointer**: TASK-2026-09-08-duplicate-active-a
- **Start Time**: 2026-09-08 14:02 UTC
- **Current Actor**: Fixture validator A
...
|---|---|---|---|---|---|
| N/A | planned | 2026-09-08 14:00 UTC | Fixture validator A | Record created | Task Record |
| planned | ready | 2026-09-08 14:01 UTC | Fixture validator A | Readiness fields complete | AC-1 |
| ready | in_progress | 2026-09-08 14:02 UTC | Fixture validator A | Work started | Verification condition |

## 6. Evidence and Completion Gate

- **Changed Files**:
  - `fixture/duplicate-active-a.md` - Synthetic fixture input.
...
- **Changed-File Summary**: First synthetic active task.
