...
- **Scenario Set [Required]**: `Trivial | Minimal Controlled | Full Controlled | TDD-enabled | CI failure`; record `N/A` only with a reason.
...
- **Trivial Work rule**: Required Adaptation questions and artifacts must remain `0`.
...
|---|---|---:|---:|---|---|---|---:|---:|---|---|
| Trivial Work | [Existing fast path] | [0] | [0] | [Not measured / result] | [Not measured / result] | [Pass / result] | [0 / result] | [0 / result] | [None / result] | [Evidence] |
...
- Trivial Work receives a required Adaptation question or artifact.
